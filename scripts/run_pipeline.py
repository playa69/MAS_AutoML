"""CLI для запуска гибридных AutoML-пайплайнов."""
...
from mas_automl.integrations import autogluon_adapter, autosklearn_adapter, fedot_adapter
from mas_automl.pipelines import HybridPipeline, registry
from mas_automl.services import PipelineOrchestrator
